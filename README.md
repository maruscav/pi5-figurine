...
In order to change the name from "heimdall" to something else, go to /etc/profile.d/figurine.sh and on line /usr/local/bin/figurine -f "3d.flf" heimdall, replace "heimdall".
